  ...
  return (
    <div>
      <div className="bg-gray-200 w-screen">
        <div>
          <p className="text-gray-700 text-center pt-10 xl:pt-12 text-2xl xl:text-4xl font-bold xl:font-semibold">
            GROW WITH US
          </p>
          <p className="text-center text-gray-700 pt-[-4px] xl:pt-1 pb-6 xl:pb-8 mx-4 xl:mx-20">
